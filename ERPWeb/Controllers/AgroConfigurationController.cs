...
namespace ERPWeb.Controllers
{
    ...
    {
        private readonly IAccessoriesInfo _accessoriesInfo;
        private readonly IAccessoriesPurchaseInfo _accessoriesPurchaseInfo;
        private readonly IAccessoriesPurchaseDetails _accessoriesPurchaseDetails;
        private readonly IAccessoriesTrackInfo _accessoriesTrackInfo;
...

        {
            ...
            this._accessoriesPurchaseDetails = accessoriesPurchaseDetails;
            this._accessoriesTrackInfo = accessoriesTrackInfo;

            this._packageInfo = packageInfo;//e  
            this._packageDetails = packageDetails;//e
        ...
        public ActionResult GetRawMaterial(string flag, long? depotId, string rawMaterialName)
        {
            try
            {
                ...
                {
                    var dto = _rawMaterialBusiness.GetRawMaterialList(rawMaterialName);
